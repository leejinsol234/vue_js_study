            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr :key="i" v-for="(product, i) in productList">
                        ...
                        <td>
                            <button type="button" class="btn btn-info me-1" @click="goToImageInsert(product.id)">
                                사진등록
                            </button>
                            <button type="button" class="btn btn-warning me-1" @click="goToUpdate(product.id)">
                                수정
                            </button>
                            <button type="button" class="btn btn-danger me-1" @click="deleteProduct(product.id)">
                                삭제
                            </button>
                        </td>
                    </tr>
