...
export default {
    ...
    //사용자 로그인 여부 체크하기(로그인한 사용자만 제품을 등록할 수 있으므로
    //computed 옵션에서 저장소의 사용자 정보 변화 여부를 항상 체크할 수 있도록 한 후,
    //mounted() 훅에서 사용자 정보 즉, this.user.email이 있는지 여부를 통해
    //사용자의 로그인 여부를 판단함.)
    computed:{
        user(){
    ...
    methods:{
        ...
        productInsert(){
            ...
            if(this.procuct.outbound_days == ""||this.product.delivery_price == 0){
